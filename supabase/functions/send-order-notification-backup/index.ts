...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    console.log("Sending backup order notification for:", orderNumber);
    ...
    // Send notification using fetch to a webhook or email service
    const emailData = {
        ...
        <div style="font-family: Arial, sans-serif; max-width: 700px; margin: 0 auto; background: #ffffff;">
          ...
          <div style="padding: 30px;">
            ...
            <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 25px;">
              ...
              <p style="margin: 5px 0;"><strong>Total Amount:</strong> <span style="color: #8B5CF6; font-weight: bold; font-size: 18px;">₹${totalAmount.toFixed(2)}</span></p>
            </div>
              ...
              <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
                ...
                <tfoot>
                  <tr style="background: #e3f2fd;">
                    ...
                    <td style="padding: 12px; text-align: right; font-weight: bold; color: #8B5CF6;">₹${totalAmount.toFixed(2)}</td>
                  </tr>
                </tfoot>
              </table>
            </div>
    ...
    // For now, just return success - you can integrate with any email service
    ...
    console.error("Error in backup send-order-notification function:", error);
    return new Response(
